...
# Mistral chat template based on official Mistral documentation
# - https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3

MISTRAL_CHAT_TEMPLATE = """<s>[INST] {instruction} [/INST] """

MISTRAL_REFUSAL_TOKS = [77]  # Example refusal token (modify as needed)
...
def format_instruction_mistral_chat(
    ...
    if system is not None:
        raise ValueError("System prompts are not explicitly supported for Mistral chat format.")
